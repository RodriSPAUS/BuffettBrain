...
type: concept
stability: high
tags: [moat, competitive-advantage, franchise, pricing-power, economic-franchise]
date: 2026-08-03
source: [[Sources/1982ltr]], [[Sources/1986ltr]], [[Sources/1991ltr]], [[Sources/2007ltr]], [[Sources/2014ltr]]
---

# Moat: Economic Competitive Advantages

## Definition and Origin

The "moat" metaphor was introduced by Warren Buffett in the [1986 Annual Letter](file:///c%3A/Users/rbaron/OneDrive%20-%20sice.com/Documentos/Cartera\Brain/wiki/Sources/1986ltr.md) to describe durable competitive advantages that protect a business from competition:

> "The difference between GEICO's costs and those of its competitors is a kind of moat that protects a valuable and much-sought-after business castle." [[Sources/1986ltr]]

> "He continually widens the moat by driving down costs still more, thereby defending and strengthening the economic franchise." [[Sources/1986ltr]]

The concept evolved from earlier observations in [1982](file:///c%3A/Users/rbaron/OneDrive%20-%20sice.com/Documentos/Cartera\Brain/wiki/Sources/1982ltr.md), where Buffett noted that in commodity industries with over-capacity, only a few producers could consistently do well if they had a cost advantage that was both wide and sustainable.

## The Economic Franchise Framework

In the [1991 Annual Letter](file:///c%3A/Users/rbaron/OneDrive%20-%20sice.com/Documentos/Cartera\Brain/wiki/Sources/1991ltr.md), Buffett provided the definitive test for economic franchises:

> "An economic franchise arises from a product or service that: (1) is needed or desired; (2) is thought by its customers to have no close substitute and; (3) is not subject to price regulation." [[Sources/1991ltr]]

> "The existence of all three conditions will be demonstrated by a company's ability to regularly price its product or service aggressively and thereby to earn high rates of return on capital." [[Sources/1991ltr]]

The observable test for a moat is therefore **pricing power**, and the observable result is **high returns on capital**.
...
- **American Express**: Network effects and trusted brand relationships
- **See's Candies**: Customer loyalty and brand recognition in a commodity product

### Switching Cost Moats
- Businesses where customers face high costs to switch providers
- Products deeply embedded in customer workflows or systems

### Network Effect Moats
- Value increases as more users join the platform
- Examples include certain technology platforms and financial services

## Characteristics of Strong Moats
...
The ultimate test of a moat is sustained high returns on capital, typically measured as:
- Return on equity (ROE)
- Return on invested capital (ROIC)
- Return on tangible assets

## Where Moats Do Not Exist
...
## Famous Moat Examples

### GEICO
- Cost advantage through operational efficiency
- Direct marketing model reducing distribution costs
- Superior claims processing

### See's Candies
- Brand loyalty and pricing power
- Ability to raise prices without significant customer loss
...
### Quantitative Tests
1. **Return on invested capital** consistently above cost of capital
2. **Pricing power** demonstrated by ability to increase prices without losing customers
3. **Market share stability** or growth over time
4. **High gross margins** indicating pricing power
5. **Low capital intensity** for growth

### Qualitative Tests
1. **Customer switching costs**
2. **Network effects**
3. **Brand strength and recognition**
4. **Regulatory protection** or patents
...
- [[Applications/BusinessQualityChecklist]] — practical application of moat analysis
- [[Sources/1982ltr]], [[Sources/1986ltr]], [[Sources/1991ltr]], [[Sources/2007ltr]], [[Sources/2014ltr]]