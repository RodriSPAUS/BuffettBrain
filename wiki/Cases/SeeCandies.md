...
See's is the purchase that changed how Buffett values a business. It is his
standing illustration of [[Concepts/EconomicGoodwill]] — a company worth far more
than its tangible assets — and of the rule that the best businesses are the ones
that *cannot* absorb their own earnings. Most later arguments about paying up for
quality trace back to it.

The 1972 acquisition predates the letters in this collection, which begin in
1977. The 2007 letter is where Buffett gives the full retrospective, and it is
the citation for the purchase figures below.
...
> business was $8 million. (Modest seasonal debt was also needed for a few months
> each year.) Consequently, the company was earning 60% pre-tax on invested
> capital." [[Sources/2007ltr]]

Volume growth over the following 35 years was almost nil:
...
> and later merged it into Berkshire.) Last year See's sold 31 million pounds, a
> growth rate of only 2% annually." [[Sources/2007ltr]]

That is the point of the case. The returns did not come from growth.

## An unexciting industry, a durable position

> "The boxed-chocolates industry in which it operates is unexciting: Per-capita
...
> profits over the last forty years." [[Sources/2007ltr]]

> "Indeed, I believe that See's, though it obtains the bulk of its revenues from
> only a few states, accounts for nearly half of the entire industry's earnings."
> [[Sources/2007ltr]]

> "Yet its durable competitive advantage, built by the See's family over a 50-year
> period, and strengthened subsequently by Chuck Huggins and Brad Kinstler, has
> produced extraordinary results for Berkshire." [[Sources/2007ltr]]

A moat, in other words, that was inherited rather than engineered, and that had
to be maintained by management rather than by capital. See [[Concepts/Moat]] and
[[Concepts/ManagementQuality]].

## The capital-allocation lesson

The framing sentence of the 2007 discussion is the one that generalises:
...
See's therefore works inside Berkshire as a funding source rather than a growth
engine: the cash it throws off is deployed elsewhere. This is the concrete case
behind [[Concepts/CapitalAllocation]].

## Economic goodwill made visible

The 1985 letter uses See's to show how small a tangible-asset base can support a
large earning power, by contrasting it with the textile operation then being
wound up:
...
> "But there is nothing routine about the management of Chuck Huggins: His daily
> involvement with all aspects of production and sales imparts a
